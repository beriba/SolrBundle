...
class SolrFacade
{
     ...
     */
    public function __construct(SolrConnectionFactory $connectionFactory, CommandFactory $commandFactory,
                                EventManager $manager, MetaInformationFactory $metaInformationFactory)
    {
    ...
    public function getRepository($entityAlias)
    {
        ...
        if (class_exists($repositoryClass))
        {
            ...
            throw new \RuntimeException(sprintf('%s must extends the FS\SolrBundle\Repository\Repository',
                                                $repositoryClass));
        }
    ...
    /**
     *
     * @param \FS\SolrBundle\Query\AbstractQuery $query
     * @return type
     */
    public function getResponse(AbstractQuery $query)
    {
     ...
     */
    public function query(AbstractQuery $query, $response)
    {
